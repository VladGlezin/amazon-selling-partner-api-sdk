...
class ItemBuyerInfo(object):
    ...
    def __init__(self, buyer_customized_info=None, gift_wrap_price=None, gift_wrap_tax=None, gift_message_text=None, gift_wrap_level=None):  # noqa: E501
    ...
    def buyer_customized_info(self):
        ...
        Buyer information for custom orders from the Amazon Custom program.  **Note**: This attribute is only available for MFN (fulfilled by seller) orders.  # noqa: E501
