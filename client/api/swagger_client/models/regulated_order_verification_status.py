...
class RegulatedOrderVerificationStatus(object):
    ...
    def __init__(self, status=None, requires_merchant_action=None, valid_rejection_reasons=None, rejection_reason=None, review_date=None, external_reviewer_id=None, valid_verification_details=None):  # noqa: E501
    ...
    def requires_merchant_action(self, requires_merchant_action):
        ...
        :type: bool
        """
        if requires_merchant_action is None:
    ...
    def valid_rejection_reasons(self, valid_rejection_reasons):
        ...
        """
        if valid_rejection_reasons is None:
