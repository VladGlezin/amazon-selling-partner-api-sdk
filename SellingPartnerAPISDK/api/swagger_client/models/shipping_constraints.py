...
class ShippingConstraints(object):
    ...
    def __init__(self, pallet_delivery=None, signature_confirmation=None, recipient_identity_verification=None, recipient_age_verification=None):  # noqa: E501
    ...
    def pallet_delivery(self):
        ...
        Indicates if the line item needs to be delivered by pallet.  # noqa: E501
    ...
    def signature_confirmation(self):
        ...
        Indicates that the recipient of the line item must sign to confirm its delivery.  # noqa: E501
    ...
    def recipient_identity_verification(self):
        ...
        Indicates that the person receiving the line item must be the same as the intended recipient of the order.  # noqa: E501
    ...
    def recipient_age_verification(self):
        ...
        Indicates that the carrier must confirm the recipient is of the legal age to receive the line item upon delivery.  # noqa: E501
